...
//    It Inflates the XML file - meaning that it creates the view
...
//    Specify where to display the data
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        val imageUrl = "https://frostyghost23.alwaysdata.net/static/images/${product.product_photo}"
